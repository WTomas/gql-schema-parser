...
/* package gql-haskell-parser-0.1.0.0 */
#ifndef VERSION_gql_haskell_parser
#define VERSION_gql_haskell_parser "0.1.0.0"
#endif /* VERSION_gql_haskell_parser */
#ifndef MIN_VERSION_gql_haskell_parser
#define MIN_VERSION_gql_haskell_parser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gql_haskell_parser */
...
#define CURRENT_COMPONENT_ID "gql-haskell-parser-0.1.0.0-inplace-gql-haskell-parser"
